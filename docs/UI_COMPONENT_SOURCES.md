...
| **Magic UI** | `StateButton` (Animated Subscribe Button / Interactive State Button) | [magicui.design/docs/components/animated-subscribe-button](https://magicui.design/docs/components/animated-subscribe-button) | MIT | `src/client/components/ui/StateButton.tsx` | All save and form commit actions: Invoice draft & issued editor, Records (Clients, Projects, Services, Starters, Milestones, Work entries, Business settings), Quotes, Email drafts, Reminder settings, Saved views, Portal settings |
...
| **Animate UI** | `ThemeToggler` | [animate-ui.com/docs/primitives/effects/theme-toggler](https://animate-ui.com/docs/primitives/effects/theme-toggler) | MIT | `src/client/components/ui/ThemeToggler.tsx` | Gradual animated theme transition effect using View Transitions API and directional clip-path wipes |
| **Animate UI** | `ThemeTogglerButton` | [animate-ui.com/docs/components/buttons/theme-toggler](https://animate-ui.com/docs/components/buttons/theme-toggler) | MIT | `src/client/components/ui/ThemeTogglerButton.tsx` | App header light/dark/system mode switcher button with tactile press feedback and icon micro-animations |
| **Animate UI** | Animated Lucide Icons (`Search`, `RefreshCw`, `Plus`, `Download`, `Trash2`, `Copy`, `Send`, `Check`, `ExternalLink`, `ArrowLeft`, `ArrowRight`, `X`, `Sparkles`, `Settings`, `Clock`, `Mail`) | [animate-ui.com/docs/icons](https://animate-ui.com/docs/icons) | MIT | `src/client/components/ui/AnimatedIcon.tsx` | Global command search, workspace refresh, New invoice creation, editor actions, modal controls, bulk operations, table row navigation, and PDF downloads |
